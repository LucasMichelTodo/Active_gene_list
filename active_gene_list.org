...
set_state <- function(df, statecol, redcol, relcol){
  ...
  df <- df %>%
    mutate(!! statecol := case_when(
                ...
                MeanRedPercent >= th_reddown &
                MaxRedPercentDif >= th_redpcntdif &
                !! relcol == 'mid' ~ 'Semiactive_FC_Dif_mid',
                ...
                MeanRedPercent < th_reddown &
                MaxRedPercentDif >= th_redpcntdif &
                !! relcol == 'mid' ~ 'Semiactive_FC_Dif_reddown_mid',
                ...
                MeanRedPercent >= th_redrescue &
                MaxRedPercentDif >= th_redpcntdif &
                !! relcol == 'mid' ~ 'Semiactive_FC_Dif_rescued_mid',
                ...
                MeanRedPercent < th_redrescue &
                MaxRedPercentDif >= th_redpcntdif &
                !! relcol == 'mid' ~ 'Semiactive_FC_Dif_noRNASeq_mid',
                ...
                ## Not settable
                ##is.na(areaFC) | is.na(MeanPercent) ~ 'Not_settable', #First set them all

                ## Then exceptions
                ## FC NA but microarray data
                !Variant &
                is.na(areaFC) &
                MeanPercent < th_rnapcnt &
                ...
                areaFC >= th_areaFC &
                MeanRedPercent >= th_redrescue &
                !! relcol == 'mid' ~ 'Semiactive_RNASeqNA_rescue_FC_mid',
                ...
                ## Microarrays NA
                !Variant &
                is.na(MeanRedPercent) &
                MeanPercent > th_rnapcnt ~ 'Active_noVar_noMicroarray',
