...
## Save results
outname <- sprintf(
  './Results_Tables/state_df_rna%s_red%s_redresc%s_reddw%s_areaFC%s_redpcntdif%s_allstrains.csv',
  th_rnapcnt, th_redpcnt, th_redrescue, th_reddown, th_areaFC, th_redpcntdif
)
write.csv(state_df, outname)

outname <- sprintf(
  './Results_Tables/state_df_rna%s_red%s_redresc%s_reddw%s_areaFC%s_redpcntdif%s_allstrains_mmnorm.csv',
  th_rnapcnt, th_redpcnt, th_redrescue, th_reddown, th_areaFC, th_redpcntdif
)
write.csv(state_df_mmnorm, outname)

outname <- sprintf(
  './Results_Tables/state_df_rna%s_red%s_redresc%s_reddw%s_areaFC%s_redpcntdif%s_allstrains_stz.csv',
  th_rnapcnt, th_redpcnt, th_redrescue, th_reddown, th_areaFC, th_redpcntdif
)
